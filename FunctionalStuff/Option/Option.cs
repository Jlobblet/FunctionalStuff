...
namespace FunctionalStuff.Option
{
    public class Option<T> : IFunctor<T>
    {
        ...
        public static Option<T> FromNullable(T input) => input switch
                                                         {
                                                             null     => None(),
                                                             { } some => Some(some)
                                                         };

        public Option<TOut> Bind<TOut>(Func<T, Option<TOut>> func) => this switch
                                                                      {
        ...
        public T DefaultValue(T def) => this switch
                                        {
                                            None<T>   => def,
                                            Some<T> s => s.Value,
        ...
        public T DefaultWith(Func<T> defThunk) => this switch
                                                  {
                                                      Some<T> s => s.Value,
                                                      None<T>   => defThunk(),
                                                      _         => throw new ArgumentException()
        ...
        public TOut Fold<TOut>(TOut state, Func<TOut, T, TOut> folder) => this switch
                                                                          {
                                                                              None<T>   => state,
        ...
        public TOut FoldBack<TOut>(Func<T, TOut, TOut> folder, TOut state) => this switch
                                                                              {
                                                                                  None<T> => state,
        ...
        public Option<TOut> Map<TOut>(Func<T, TOut> mapping) => this switch
                                                                {
                                                                    None<T>   => Option<TOut>.None(),
        ...
        public Option<TOut> Map2<T2, TOut>(Func<T, T2, TOut> mapping, Option<T2> other) => (this, other) switch
            {
        ...
        public T UnwrapOr(Exception exception) => this switch
                                                  {
                                                      Some<T> s => s.Value,
                                                      _         => throw exception
                                                  };
